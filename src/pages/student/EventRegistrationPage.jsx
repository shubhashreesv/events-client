                ...
                {selectedEvent.formEmbedCode ? (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <button onClick={() => navigate('/')} className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-3 px-4 rounded-xl font-semibold transition-all duration-200 text-center">Back to Events</button>
                    </div>
                  </div>
                ) : selectedEvent.formLink ? (
                  <div className="space-y-4">
                  ...
                  <div className="text-center py-8">
                    ...
                    <button onClick={() => navigate('/')} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-xl font-semibold transition-all duration-200">Browse Other Events</button>
                  </div>
                )}
              </div>
            </div>
